      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-[45%]">
            ...
            <h1 className="text-6xl font-600">Spring / Summer Collection</h1>
            <p className="py-5">
          ...
          {categories.map((item, index) => (
            <div key={index} className="relative overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black/20 flex flex-col justify-end p-6 text-white">
                ...
                <Link to={item.links}>
                <span className="text-sm mt-1 cursor-pointer hover:border-b-[1.5px]  hover:pb-0.125">SHOP NOW</span>
                </Link>
              </div>
            </div>
          ))}
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-sm text-gray-500">On orders over $99</p>
            </div>
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className=" mb-8 text-black">
            Discover our completely curated selection of the season's most
            coveted pieces, handpicked by our fashion experts.
          </p>
